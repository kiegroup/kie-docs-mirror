...
:PRODUCT_PAM_SHORT: Process Automation Manager
...
:HEADLESS_CONTROLLER: headless Process Automation Manager controller
:CONTROLLER: Process Automation Manager controller
...
:PACKAGING_DEPLOYING_PROJECT: Packaging and deploying an {PRODUCT} project
...
:DEPLOYING_OPENSHIFT_OPERATOR: Deploying an {PRODUCT} environment on {OPENSHIFT} {OPENSHIFT_VERSION_SHORT} using Operators
:DEPLOYING_OPENSHIFT_TEMPLATES: Deploying an {PRODUCT} environment on {OPENSHIFT} {OPENSHIFT_VERSION_SHORT_OLD} using templates
