...
.Procedure
. With the *IT_Orders_New* project deployed and running in {KIE_SERVER}, in a web browser, navigate to the Showcase login page `http://localhost:8080/bamoe-case-mgmt-showcase/`.
+
